...
# Addendum â€” 2026-09-20 (source published; hosting still blocked)
...
# Addendum 2 â€” 2026-09-20/21: hosted activation COMPLETE, authenticated journey VERIFIED
...
First tenant created through the product UI: DONE
  evidence: filled the platform create-business form and saved -> "Saved successfully."
    Row after save: "IDash â€” Datachron Solutions   other Â· Starter Â· trial
    0 / 10 users Â· 0 / 1000 clients Â· 0 follow-ups   Manage   Invite admin
    1â€“1 of 1 records".
...
Invitation issued and accepted: DONE
  ...
  evidence: signed in as the invited address and accepted -> the workspace becomes
    "IDash â€” Datachron Solutions" with role admin and the account name "IDash Business Admin".
