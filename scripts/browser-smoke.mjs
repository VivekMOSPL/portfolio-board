...
assert.equal(await page.getByText("invitee@example.test").first().isVisible(),true,"the invited address must be named");
console.log("Signed-out invite shows one password step and names the invited address");
